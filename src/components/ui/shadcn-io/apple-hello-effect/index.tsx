...
function AppleJonathanEffect({
  ...
  return (
    ...
    >
      ...
      {/* J - curved descender */}
      <motion.path
        d="M30 20 Q 35 18 40 20 Q 48 24 48 35 L 48 85 Q 48 105 38 115 Q 30 120 22 115 Q 18 110 20 105"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* o */}
      <motion.path
        d="M85 85 Q 75 85 70 95 Q 68 105 75 112 Q 85 118 95 112 Q 102 105 100 95 Q 98 85 85 85 Z"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* n - first stroke */}
      <motion.path
        d="M135 120 L 135 85 Q 140 78 148 85 L 148 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* n - second hump */}
      <motion.path
        d="M148 85 Q 155 78 163 85 L 163 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* a - circular part */}
      <motion.path
        d="M205 95 Q 195 95 193 105 Q 195 115 205 115 Q 218 115 220 105 L 220 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(2),
          opacity: { duration: 0.3, delay: calc(2) },
        }}
      />
      ...
      {/* t - vertical */}
      <motion.path
        d="M260 65 L 260 115 Q 260 122 265 122"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeOut",
          delay: calc(2.9),
          opacity: { duration: 0.25, delay: calc(2.9) },
        }}
      />
      ...
      {/* h - hump */}
      <motion.path
        d="M310 85 Q 318 78 326 85 L 326 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* a - circular */}
      <motion.path
        d="M368 95 Q 358 95 356 105 Q 358 115 368 115 Q 381 115 383 105 L 383 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(4.7),
          opacity: { duration: 0.3, delay: calc(4.7) },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          ...
          ease: "easeOut",
          delay: calc(5.3),
          opacity: { duration: 0.15, delay: calc(5.3) },
        }}
      />

      {/* n - first stroke */}
      <motion.path
        d="M423 120 L 423 85 Q 428 78 436 85 L 436 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeOut",
          delay: calc(5.6),
          opacity: { duration: 0.25, delay: calc(5.6) },
        }}
      />

      {/* n - second hump */}
      <motion.path
        d="M436 85 Q 443 78 451 85 L 451 120"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeOut",
          delay: calc(6.1),
          opacity: { duration: 0.2, delay: calc(6.1) },
        }}
        onAnimationComplete={onAnimationComplete}
      />
    </motion.svg>
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, AppleJonathanEffect };
